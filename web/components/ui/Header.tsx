...
export default function Header() {
  return (
    <header className="flex items-center justify-between py-8">
      ...
      <SearchModal>
        <button className="rounded bg-cyan-350 px-4 py-2 font-medium tracking-wide text-zinc-900/90 outline-none ring-1 ring-cyan-450 transition-colors duration-200 ease-out active:bg-cyan-550">
          Search
        </button>
      </SearchModal>
    </header>
