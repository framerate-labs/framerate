        ...
        {src && (
          <>
            <Image
              ...
              width={width}
              height={height}
              className={`${classes} opacity-1 absolute rounded object-cover blur-[4px] drop-shadow [image-rendering:_pixelated]`}
            ...
            <Image
              ...
              width={width}
              height={height}
              className={`${classes} peer relative top-0 select-none rounded object-cover drop-shadow`}
