...
<div
	class="-mt-14 grid w-full grid-cols-3 md:-mt-44 md:grid-rows-2 lg:grid-cols-4 lg:grid-rows-none"
>
	<aside
	...
	>
		...
		>
			<h3 class="text-sm font-medium uppercase tracking-wide text-balance">
				{media.tagline}
			</h3>
			<p
				class="mt-2 text-sm font-medium leading-normal tracking-wider text-pretty md:text-base md:tracking-wide lg:mt-4"
			>
				{media.overview}
			</p>
		</div>
